...
It recursively explores folders, files inside ZIPs or **cover arts inside music files** (IDv3, APE tags etc.), and supports **140+ file formats** by integrating many specialized encoders.
