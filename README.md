...
It recursively explores folders, files inside ZIPs or **cover arts inside music files** (IDv3, APE tags etc.), and supports **150+ file formats** by integrating many specialized encoders.
...
| Documents     | Portable Executable (PE)   | application/x-msdownload, application/vnd.microsoft.portable-executable                                                                                                                                                                                                                                                                                                                                                                                                                          | .exe, .dll, .ocx, .scr, .cpl                                                                                                                                                                                                                    | Internal                              |
